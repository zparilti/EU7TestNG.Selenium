...
public class AttributeTest {
    ...
    @Test
     public void test1() throws InterruptedException {
        ...
        System.out.println("blueRadioBtn.getAttribute() = " + blueRadioBtn.getAttribute("type"));
        //get the value of name attribute
        System.out.println("blueRadioBtn.getAttribute() = " + blueRadioBtn.getAttribute("name"));
        ...
        System.out.println("blueRadioBtn.getAttribute() = " + blueRadioBtn.getAttribute("checked"));
